...
export const modelPresets: ModelPreset[] = [
  ...
  },
  {
    ...
    family: "qwen",
    installKind: "qwenGguf",
    size: "约 972 MiB",
    quality: "Q8 量化，准确率优先，转录速度更快",
    memory: "建议 8 GB 以上内存",
    recommendedFor: "文件转录推荐；运行组件已随应用提供",
    license: "Apache 2.0 / llama.cpp MIT",
    downloadUrl: "https://huggingface.co/ggml-org/Qwen3-ASR-0.6B-GGUF",
    engineNote: "下载 Q8 主模型和音频投影器，使用应用内置的 llama.cpp CPU 服务。",
    modelFiles: [
      {
        path: "Qwen3-ASR-0.6B-Q8_0.gguf",
        url: hf("ggml-org/Qwen3-ASR-0.6B-GGUF", "Qwen3-ASR-0.6B-Q8_0.gguf?download=true"),
        size: 804749248,
        sha256: "bca259818b50ca7c4c05e9bdb35a5dc04fa039653a6d6f3f0f331f96f6aa1971",
      },
      {
        path: "mmproj-Qwen3-ASR-0.6B-Q8_0.gguf",
        url: hf("ggml-org/Qwen3-ASR-0.6B-GGUF", "mmproj-Qwen3-ASR-0.6B-Q8_0.gguf?download=true"),
        size: 214392480,
  ...
  {
    id: "qwen3-asr-0.6b",
    name: "Qwen3-ASR 0.6B 兼容版",
    family: "qwen",
    installKind: "sherpaOnnx",
    size: "约 1 GB",
    quality: "新一代多语种 ASR，质量更高",
    memory: "建议 8 GB 以上内存",
    recommendedFor: "旧设备和高效版异常时的兼容回退",
    license: "Apache 2.0",
