...
- 推荐普通用户使用 `Hi-Voicer_1.0.10_x64-setup.exe`
- 也可以下载同版本 MSI 安装包
...
1.0.10 keeps Sherpa-ONNX CPU as the default stable path for ordinary Windows machines. CUDA product entry points have been removed; DirectML is available as a per-machine acceleration path after the Diagnostics CPU vs DirectML benchmark passes.
...
```powershell
gh attestation verify .\Hi-Voicer_1.0.10_x64-setup.exe --repo cg202601/Hi-Voicer
```
